                                                            ...
                                                            <td align="center"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <a href="{{ route('reset.password.get') }}?token={{ $token }}&email={{ $email }}"
                                                    ...
                                                    <p
                                                        ...
                                                        into your web browser: <span class="break-all"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                href="http://imamjie.local/reset-password/6e389c3a2b6dc9b58ffab876fbcfde561d56ec46c73c7d4b003d6150757df237?email=testing%40mail.com"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4;">http://imamjie.local/reset-password/6e389c3a2b6dc9b58ffab876fbcfde561d56ec46c73c7d4b003d6150757df237?email=testing%40mail.com</a></span>
                                                    </p>
